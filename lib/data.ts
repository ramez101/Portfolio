...
export const techStack: TechCard[] = [
  { icon: '☕', name: 'Java / JEE', category: 'Backend', level: 80 },
  { icon: '🌐', name: 'HTML / CSS', category: 'Frontend', level: 100 },
  { icon: '⚡', name: 'JavaScript', category: 'Frontend', level: 75 },
  ...
  { icon: '🔥', name: 'Flask', category: 'Backend', level: 70 },
  { icon: '🗄️', name: 'SQL', category: 'Base de données', level: 85 },
  { icon: '🐘', name: 'PostgreSQL', category: 'Base de données', level: 70 },
  { icon: '🛍️', name: 'PrestaShop', category: 'E-commerce', level: 90 },
  { icon: '🤖', name: 'IA / LLM', category: 'IA', level: 70 },
  { icon: '🐳', name: 'Docker', category: 'DevOps', level: 50 },
  { icon: '📊', name: 'Pandas', category: 'Data', level: 72 },
  { icon: '🔌', name: 'REST / SOAP', category: 'API', level: 82 },
  { icon: '🦁', name: 'WildFly', category: 'Serveur', level: 76 },
  { icon: '📄', name: 'JSF / Primefaces', category: 'UI Backend', level: 84 },
]
